...
export const p33Abi = [
  ...
  {
    inputs: [{ components: aggregatorSwapTuple, internalType: "struct IP33.AggregatorSwapParams", name: "params", type: "tuple" }],
    name: "swapIncentiveViaAggregator",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function"
  },
